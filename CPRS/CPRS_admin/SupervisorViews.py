...
from .models import Supervisor_Profile, Supervisor, StudentGroup, Project, Student, Client, Task
...
def supervisor_view_group_details(request,group_id):
    ...
    context = {"project":project,"students":students,"group":group,"client":client}
    return render(request, template_name,context)
