    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projectclientid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CPRS_admin.client')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taskprojectid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CPRS_admin.project')),
            ],
        ),
        migrations.CreateModel(
            name='Supervisor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('students', models.ManyToManyField(through='CPRS_admin.Student', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Student_Task',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CPRS_admin.student')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='student',
            name='group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='CPRS_admin.studentgroup'),
        ),
        migrations.AddField(
            model_name='student',
            name='user',
