...
class IndustryClient(models.Model):
    client = models.OneToOneField(Client,primary_key=True,default=None,related_name="industry",on_delete=models.CASCADE)
    company = models.CharField(max_length=50,null=True)
    address = models.TextField(null=True)
    contact  = PhoneNumberField(null=True,unique=True)

class MLEClient(models.Model):
    client = models.OneToOneField(User,primary_key=True,default=None,related_name="mle",on_delete=models.CASCADE)    
class UniversityClient(models.Model):
    client = models.OneToOneField(User,primary_key=True,default=None,related_name="university",on_delete=models.CASCADE)
